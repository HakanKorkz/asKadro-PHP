...
-- Üretim Zamanı: 19 Ara 2021, 19:13:36
...
INSERT INTO `companies` (`ID`, `companyCode`, `companyName`, `companyEmail`, `companyPassword`, `companyPhone`, `companyHumanResourcesPhone`, `companyHumanResourcesName`, `companyLocation`, `companyGivePrice`, `companyTaxNumber`, `companyInvoice`, `companyService`, `companyCreateDate`) VALUES
(3, 1639309945, 'Korkmaz yazılım', 'info@korkmazyazilim.com', 'e10adc3949ba59abbe56e057f20f883e', '0531235095', '0531235095', NULL, 'Sakarya', '1500.00', '5111196395', 'bilinmiyor', 'true', '2021-12-12 14:52:25'),
(4, 1639317016, 'Korkmaz yazılım', 'info@korkmazyazilim.com', 'e10adc3949ba59abbe56e057f20f883e', '0531235095', 'Erdo', '0531235096', 'Sakarya', '1500.00', '5111196395', 'bilinmiyor', 'true', '2021-12-12 16:50:16');
...
(6, 1639940729, 'hakan', 'korkmazz', 'hakan.gasaray@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '05384034364', '2021-12-03', 'Garson', 'Şemdili', '55919782267', 'TR100006216481947812676891'),
(7, 1639941179, 'hakan', 'korkmazz', 'hakan.hizmet.54.gs@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '05384034367', '2021-12-03', 'Garson', 'Şemdili', '55919782269', 'TR100006216481947812676891');
...
INSERT INTO `files` (`ID`, `fileCode`, `commonCode`, `filePath`, `fileName`) VALUES
(17, 1639941189, 1639941179, 'uploads/employees/img/1639941179.jpg', '1639941179');
